...
<div class="container mx-auto mt-24 px-4">
    <div class="text-center mb-6">
        <h1 class="text-3xl font-semibold">Mis reservas pendientes</h1>
    </div>
    <div class="px- grid xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-6 mb-16">
        <%
            ...
            if (usuarioLogueado instanceof Usuario) {
                reservasPendientes = ((Usuario) usuarioLogueado).reservasPendientes();
            } else {
                ...
                reservasPendientes = reservasPendientesTemp;
            }
        ...
        %>
        <!-- Tarjeta Reserva -->
        <a href="vistaReserva.jsp?idReserva=<%=r.getId()%>"
