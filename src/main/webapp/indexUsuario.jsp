...
<%
    ...
    try {
        ...
        viviendas = fernanbnbAPP.getAllViviendas();
        ...
        if (fernanbnbAPP == null || viviendas == null || imagenesViviendas == null) {
...
<%
} else { // Si hay viviendas
%>


<div class="container mx-auto mt-32 px-4">

    <div class=" grid xl:grid-cols-4  md:grid-cols-3 sm:grid-cols-2 gap-6 mb-16">
        <%
