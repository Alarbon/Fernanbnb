...
<div class="flex flex-col md:flex-row justify-center items-center min-h-screen p-4 md:p-0">
  <div class="text-center md:text-left max-w-screen-md mt-16 md:mt-0 md:ml-8">
    <p class="text-4xl font-bold">Su petición se ha realizado con éxito.</p>
    <p class="text-lg text-green-600 mt-2">
      <% if (session.getAttribute("exito") == null) response.sendRedirect("index.jsp"); %>
  ...
  <img class="mt-4 w-full md:w-auto max-w-md h-auto mx-auto md:mx-0"
       src="https://cdn.discordapp.com/attachments/1147607064525414410/1152017574503129198/successfully-done-5627021-4699001.gif"
       alt="Exito GIF">
</div>
