...
<div class="container mx-auto p-8 mt-20">
    <h1 class="text-3xl font-semibold lg:mb-14 mb-10 text-center">Mis Reservas</h1>

    <div class="flex flex-col lg:flex-row items-center justify-center">
        <%
            if (usuarioLogueado instanceof Propietario) {
        %>
        <!-- Periodo no Disponibilidad Button -->
        <a href="vistaPeriodoNoDisponible.jsp"
           class="lg:w-1/3 bg-orange-500  text-white text-center py-16 lg:py-28 px-6 lg:px-8 rounded-lg mb-4 lg:mb-0 mx-4 hover:bg-orange-600 transition duration-300">
            <h2 class="text-3xl font-semibold">No Disponibles</h2>
        </a>
        <%
            }
        %>
        ...
        <a href="reservasPendientes.jsp"
           class="lg:w-1/3 bg-red-500  text-white text-center py-16 lg:py-28 px-6 lg:px-8 rounded-lg mb-4 lg:mb-0 mx-4 hover:bg-red-600 transition duration-300">
            <h2 class="text-3xl font-semibold">Reservas Pendientes</h2>
        </a>

        <!-- Reservas Finalizadas Button -->
        <a href="reservasFinalizadas.jsp"
           class="lg:w-1/3 bg-gray-500 text-white text-center py-16 lg:py-28 px-6 lg:px-8 rounded-lg mx-4 hover:bg-gray-600 transition duration-300">
            <h2 class="text-3xl font-semibold">Reservas Finalizadas</h2>
        </a>
    </div>
</div>
