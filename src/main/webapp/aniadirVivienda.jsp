...
<!-- contenido principal -->
<main class="container mx-auto p-4 mt-14 mb-14">

<section  class="bg-white p-4 sm:p-6 md:p-8 mt-4 rounded-lg ">
    <p class="text-xl sm:text-3xl font-semibold mb-10">Añade tu vivienda en Fernanbnb.</p>

    <form id="addViviendaForm" action="validacionAddVivienda.jsp" method="get">
        <div class="mb-4">
            <label for="tituloVivienda" class="block font-semibold">Titulo de la Vivienda:</label>
            <input type="text" id="tituloVivienda" name="tituloVivienda" placeholder="Casita Villa Logroño"
                   class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300" required>
        </div>

        <div class="mb-4">
            <label for="descripcionVivienda" class="block font-semibold">Descripción:</label>
            <textarea id="descripcionVivienda" name="descripcionVivienda" placeholder="Bonita casa con piscina y amplia terraza..."
                      class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300" required></textarea>
        </div>

        <div class="mb-4">
            <label for="localidad" class="block font-semibold">Localidad:</label>
            <input type="text" id="localidad" name="localidad" placeholder="Logroño"
                   class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300" required>
        </div>

        <div class="mb-4">
            <label for="provincia" class="block font-semibold">Provincia:</label>
            <input type="text" id="provincia" name="provincia" placeholder="La Rioja"
                   class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300" required>
        </div>

        <div class="mb-4">
            <label for="numHuespedes" class="block font-semibold">Número de Huéspedes Máximos:</label>
            <input type="number" id="numHuespedes" name="numHuespedes" placeholder="4"
                   class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300 " required min="1">
        </div>

        <div class="mb-4">
            <label for="precioNoche" class="block font-semibold">Precio por Noche en euros:</label>
            <input type="number" id="precioNoche" name="precioNoche" placeholder="100"
                   class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300" required min="1">
        </div>
